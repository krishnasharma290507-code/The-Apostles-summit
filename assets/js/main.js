...
const NPC = {
  ...
  getReply(msg) {
    ...
    if (/date|when|schedule|timing|october/.test(m)) return "The Apostles Summit takes place on October 17-18, 2026 in New Delhi. Two days of intense diplomacy and debate!";
...
(function(){
  ...
  const CONF_DATE_LABEL = 'October 17 \u2013 18, 2026';
  const el = {
